...
const DALLE = () => {
  ...
  return (
    <div>
      ...
      <Button variant="contained" color="secondary" onClick={generateImage} disabled={isLoading}>
    ...
    <p><b>CONSIGLI PER GENERARE IMMAGINI MIGLIORI</b></p>
      <p> <b>  Specifica chiaramente l intento:</b> Inizia il tuo prompt descrivendo in modo chiaro e conciso ciò che desideri generare. Fornisci dettagli sulla forma, il colore, la disposizione degli oggetti, le pose, le espressioni facciali o qualsiasi altro aspetto rilevante dell'immagine che vuoi generare. <br></br> 
          <br></br><b>  Utilizza descrizioni dettagliate:</b> Più i dettagli sono specifici, migliori saranno le probabilità di ottenere un'immagine che corrisponde alle tue aspettative. Usa descrizioni precise per gli oggetti, le caratteristiche e le relazioni spaziali tra gli elementi. <br></br> 
          ...
          <br></br><b>Esperimenti progressivi:</b> Se l immagine generata non soddisfa completamente le tue aspettative, puoi provare ad affinare il prompt in modo incrementale. Modifica leggermente le descrizioni, gli attributi o le specifiche dell'immagine per ottenere risultati più precisi. <br></br> 
