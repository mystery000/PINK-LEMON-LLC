...
function Prices() {
    return (
        <>
            ...
            <h2 className="h2-description">Presto sarà possibile acquistare token con pacchetti e abbonamenti</h2>

            <div className="blog1">
                <TabMenuPrices></TabMenuPrices>
            </div>
            <p>
                * <b>La guida ai migliori prompt è in italiano</b> ed è uno strumento fondamentale per
